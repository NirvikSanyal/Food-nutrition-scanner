...
application.secret_key = "barcode_scanner_secret_key"
...
@application.route('/detect_barcode', methods=['POST'])
def detect_barcode():
    try:
...
# At bottom, replace __name__ block:
if __name__ == '__main__':
    port = int(os.environ.get('PORT', 8000))  # EB sets PORT=8000
    application.run(debug=False, host='0.0.0.0', port=port)  # Disable debug in prod
